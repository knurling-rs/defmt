...
fn main() -> ! {
    ...
    defmt::info!("Sec ms  {:ms}", 1_234_567);
    defmt::info!("Sec us  {:us}", 1_234_567);

    // Timestamps with time format
    defmt::info!("Time s  {:ts}", 1_234_567);
    defmt::info!("Time ms {:tms}", 1_234_567);
    defmt::info!("Time us {:tus}", 1_234_567);
