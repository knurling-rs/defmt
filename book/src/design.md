...
Unstructured, braindump-ish notes about the design and implementation of `binfmt`
...
`binfmt` avoids this by placing all the required information *for formatting* in a "side table" (see [the interning section](./interning.md)).
